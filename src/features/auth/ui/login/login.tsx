...
import { selectIsCaptcha, selectIsLoggedIn } from "features/auth/model/auth.selectors";
        ...
        <form onSubmit={formik.handleSubmit}>
          <FormControl>
            ...
            <FormGroup>
              ...
              {captcha !== "" &&
              <TextField type="text" label="Anti bot symbol" margin="normal" {...formik.getFieldProps("captcha")} />}
